...
public class FloatWidgetService extends Service {
    ...
    public void onCreate() {
        ...
        TextView mone = mFloatingWidget.findViewById(R.id.one);
        TextView mtwo = mFloatingWidget.findViewById(R.id.two);
        TextView mthree  = mFloatingWidget.findViewById(R.id.three);

        mone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Toast.makeText(FloatWidgetService.this, "HEllo", Toast.LENGTH_SHORT).show();
